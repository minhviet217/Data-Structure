...
public class WhatHappened {
    ...
    private Pokemon1 attacker;
    private Pokemon1 victim;
    ...
    */
    public WhatHappened(Pokemon1 attacker, Pokemon1 victim, String typeOfAttack, int amtOfDamage) {
